...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in clone_client/state_store/proto/state_store_pb2_grpc.py depends on'
...
class StateStoreReceiverGRPCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubscribeTelemetry = channel.unary_stream(
                ...
                response_deserializer=clone__client_dot_state__store_dot_proto_dot_state__store__pb2.TelemetryDataResponse.FromString,
        ...
        self.GetSystemInfo = channel.unary_unary(
                ...
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=clone__client_dot_state__store_dot_proto_dot_state__store__pb2.SystemInfoResponse.FromString,
                _registered_method=True)
...
def add_StateStoreReceiverGRPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SubscribeTelemetry': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=clone__client_dot_state__store_dot_proto_dot_state__store__pb2.TelemetryDataResponse.SerializeToString,
            ),
            ...
            'GetSystemInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=clone__client_dot_state__store_dot_proto_dot_state__store__pb2.SystemInfoResponse.SerializeToString,
            ),
...
class StateStoreReceiverGRPC(object):
    ...
    def SubscribeTelemetry(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            clone__client_dot_state__store_dot_proto_dot_state__store__pb2.TelemetryDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetSystemInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/clone.state_store.StateStoreReceiverGRPC/GetSystemInfo',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            clone__client_dot_state__store_dot_proto_dot_state__store__pb2.SystemInfoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
